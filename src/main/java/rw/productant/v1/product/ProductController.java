...
public class ProductController {
    ...
    @PostMapping
    public ResponseEntity<ApiResponsePayload> create(@RequestBody @Valid  ProductDto productDto) {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<ApiResponsePayload> update(@PathVariable UUID id, @RequestBody @Valid ProductDto productDto) {
